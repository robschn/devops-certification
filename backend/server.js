...
const mockEvents = {
    events: [
        { title: 'DevOps Training Day 1', id: 1, description: 'Some really cool training about Git!' },
        { title: 'DevOps Training Day 2', id: 2, description: 'Even cooler training about Docker!' }
    ]
};
